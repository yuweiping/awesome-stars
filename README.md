...
*   [Cosium/git-code-format-maven-plugin](https://github.com/Cosium/git-code-format-maven-plugin) - A maven plugin that automatically deploys code formatters as pre-commit git hook
